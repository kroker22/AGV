...
const int enc_motorDA = 2;
const int enc_motorDB = 23;
# 673 "/home/user/arduino/arduino.ino"
int Motor_PWM = 50;

void ADVANCE() {
  do{digitalWrite(34 /* A motor direction*/, 0x0); digitalWrite(35, 0x1); analogWrite(12 /* A motor speed */, Motor_PWM);} while (0);
  do{digitalWrite(37, 0x1); digitalWrite(36, 0x0); analogWrite(8 /* B motor speed */, Motor_PWM);} while (0);
  do{digitalWrite(43, 0x0); digitalWrite(42, 0x1); analogWrite(6 /* C motor speed  */, Motor_PWM);} while (0);
  do{digitalWrite(A4, 0x1); digitalWrite(A5, 0x0); analogWrite(5 /* D motor speed*/, Motor_PWM);} while (0);
}

void BACK() {
  do{digitalWrite(34 /* A motor direction*/, 0x1); digitalWrite(35, 0x0); analogWrite(12 /* A motor speed */, Motor_PWM);} while (0);
  do{digitalWrite(37, 0x0); digitalWrite(36, 0x1); analogWrite(8 /* B motor speed */, Motor_PWM);} while (0);
  do{digitalWrite(43, 0x1); digitalWrite(42, 0x0); analogWrite(6 /* C motor speed  */, Motor_PWM);} while (0);
  do{digitalWrite(A4, 0x0); digitalWrite(A5, 0x1); analogWrite(5 /* D motor speed*/, Motor_PWM);} while (0);
}

void LEFT_1() {
  do{digitalWrite(34 /* A motor direction*/, 0x0); digitalWrite(35, 0x0); analogWrite(12 /* A motor speed */, 0);} while (0);
  do{digitalWrite(37, 0x1); digitalWrite(36, 0x0); analogWrite(8 /* B motor speed */, Motor_PWM);} while (0);
  do{digitalWrite(43, 0x0); digitalWrite(42, 0x1); analogWrite(6 /* C motor speed  */, Motor_PWM);} while (0);
  do{digitalWrite(A4, 0x0); digitalWrite(A5, 0x0); analogWrite(5 /* D motor speed*/, 0);} while (0);
}
...
void LEFT_3() {
  do{digitalWrite(34 /* A motor direction*/, 0x1); digitalWrite(35, 0x0); analogWrite(12 /* A motor speed */, Motor_PWM);} while (0);
  do{digitalWrite(37, 0x0); digitalWrite(36, 0x0); analogWrite(8 /* B motor speed */, 0);} while (0);
  do{digitalWrite(43, 0x0); digitalWrite(42, 0x0); analogWrite(6 /* C motor speed  */, 0);} while (0);
  do{digitalWrite(A4, 0x0); digitalWrite(A5, 0x1); analogWrite(5 /* D motor speed*/, Motor_PWM);} while (0);
}
...
void IO_init() {
  pinMode(12 /* A motor speed */, 0x1);
  pinMode(34 /* A motor direction*/, 0x1);
  pinMode(35, 0x1);
  pinMode(8 /* B motor speed */, 0x1);
  pinMode(37, 0x1);
  pinMode(36, 0x1);
  pinMode(6 /* C motor speed  */, 0x1);
  pinMode(43, 0x1);
  pinMode(42, 0x1);
  pinMode(5 /* D motor speed*/, 0x1);
  pinMode(A4, 0x1);
  pinMode(A5, 0x1);

  pinMode(enc_motorAA, 0x0);
  pinMode(enc_motorAB, 0x0);
  pinMode(enc_motorBA, 0x0);
  pinMode(enc_motorBB, 0x0);
  pinMode(enc_motorCA, 0x0);
  pinMode(enc_motorCB, 0x0);
  pinMode(enc_motorDA, 0x0);
  pinMode(enc_motorDB, 0x0);
...
# 812 "/home/user/arduino/arduino.ino" 3
   __asm__ __volatile__ ("cli" ::: "memory")
# 812 "/home/user/arduino/arduino.ino"
                 ;
...
# 824 "/home/user/arduino/arduino.ino" 3
   __asm__ __volatile__ ("sei" ::: "memory")
# 824 "/home/user/arduino/arduino.ino"
               ;
